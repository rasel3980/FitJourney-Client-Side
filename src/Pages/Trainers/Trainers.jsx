      ...
      <div className="w-11/12 mx-auto my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {trainers.map((trainer) => {
          return (
            <div
  key={trainer._id}
  className="max-w-xs rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800 flex flex-col"
>
  <img
                ...
                {dayObj.timeSlots.map((slot) => (
                  ...
                  >
                    ...
                    {slot.isAvailable ? (
                      ...
                      <div className="inline-block">
                        <RxCross2 className="inline-block" /> Not Available
                      </div>
                    )}
                  </li>
                ))}
  ...
  <Link
    ...
    className="flex items-center justify-center w-full p-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50"
  >
    <button className="bg-cyan-500 py-3 px-5 rounded-xl mt-auto">
      See More
    </button>
  </Link>
</div>
